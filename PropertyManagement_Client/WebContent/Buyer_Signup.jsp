...
<body>
	...
	<div class="container">
		...
		<form class="form-signin" action="BSignUp" method="post">
			<h3 class="">Personal Details</h3>

			<input type="text" class="input-block-level" placeholder="First Name"
				name="fName" required> 
			<input type="text"
				class="input-block-level" placeholder="Last Name" name="lName"
				required>
		 <input type="email" class="input-block-level"
				placeholder="Email" required name="eMail">
				<br> 
		<input
				type="text" class="input-block-level" placeholder="Contact Number" required
				name="cNumber"> <br> <br>
