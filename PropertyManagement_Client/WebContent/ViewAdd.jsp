			...
			<div class="span15 well">
				...
				<center>
					...
					<br> <br> <br> <br> <img
						...
						alt="images/4.jpg" height="50%;" width="300px;">
						 <img
					...
					<table cellpadding="10px" cellspacing="100px">
						...
						<tr>
							<td><a href="Agent_Adds_Display.jsp" class="btn btn-success"><< Back</a></form></td>
							<td><form method="get" action="Modify_Add.jsp">&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;<input type="submit" value="Modify" class="btn btn-danger"></td>
						</tr>
					</table>
