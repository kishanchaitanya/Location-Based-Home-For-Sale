...
body {
background-image: url(assets/img/main-bg.jpg); /*You will specify your image path here.*/
...
<div class="navbar navbar-inverse navbar-fixed-top">
	...
	<div class="container">
		...
		<form class="form-signin" method="post" action="ULogin">
			<h2 class="form-signin-heading">Please Sign In</h2>
			<input type="text" class="input-block-level"
				placeholder="Username" name="uName" required> 
			<input type="password"
				class="input-block-level" placeholder="Password" required name="uPass"> 
			<label
